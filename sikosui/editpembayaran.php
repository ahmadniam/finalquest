        ...
        <div class="box box-success">
          ...
          if ($_POST['simpan'])
          {
            ...
            $kamar=$_POST['kamar'];
                  ...
                  $s=mysqli_query($koneksi,"update pembayaran set nama='$nama', untuk='$untuk', jumlah='$jumlah', metode_pembayaran='$metode_pembayaran',
                  tanggal_pembayaran='$tanggal_pembayaran', kamar='$kamar' where id_pembayaran='$id_pembayaran' ");
                  if ($s)
                  {
