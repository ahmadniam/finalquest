                  ...
                  if ($_POST['tambah'])
                  {
                    ...
                    $kamar=$_POST['kamar'];
                      ...
                      if ($cek1==1) {
                        ...
                        $s=mysqli_query($koneksi,"insert into penghuni (nama_penghuni,alamat,no_telp,nama_ortu,no_telp_ortu,kampus,jurusan,angkatan,email,kamar,id_penghuni)
                                values('$nama_penghuni','$alamat','$no_telp','$nama_ortu','$no_telp_ortu','$kampus','$jurusan','$angkatan','$email','$kamar','$id_penghuni')");
                          if ($s)
                          {
                              echo "<div class='alert alert-success'><h4>Data penghuni sudah ditambahkan</h4></div><br>";
                              echo "<meta http-equiv=refresh content=2;url=index.php?page=penghuni>";
                          }
                          else
                          {
