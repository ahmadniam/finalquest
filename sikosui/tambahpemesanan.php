        ...
        <div class="box box-success">
          ...
          <?php
            ...
            if ($_POST['tambah'])
            {
              ...
              no_telp_pemesan='$no_telp_pemesan', masa_sewa='$masa_sewa', status_pemesanan='$status_pemesanan' ");
              if ($s&&$qw)
              {
                  echo "<div class='alert alert-success'><h4>Input Data Pemesanan Berhasil.</h4></div><br>";
